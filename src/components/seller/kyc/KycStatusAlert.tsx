    ...
    switch (status) {
      ...
      case 'requires_more_info':
        return {
          ...
          icon: AlertCircle,
          styles: 'bg-indigo-500/10 border-indigo-500/20 text-indigo-400',
        }
      case 'not_started':
      default:
        return {
          ...
          icon: ShieldCheck,
          styles: 'bg-slate-900 border-white/5 text-slate-300',
        }
    }
  }
      ...
      <div className="flex-1 space-y-1">
        ...
        {status === 'not_started' && onStartVerification && (
          <button
            ...
            className="mt-3 rounded-xl bg-indigo-650 hover:bg-indigo-700 px-4 py-2 text-[10.5px] font-bold text-white transition-all shadow-md"
          >
