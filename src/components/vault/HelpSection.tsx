...
import { LifeBuoy, MessageSquare, AlertTriangle, ExternalLink } from 'lucide-react'
  ...
  return (
    <div className="rounded-[24px] border border-white/5 bg-slate-900/30 p-6">
      ...
      <div className="flex flex-col gap-3">
        ...
        <button 
          onClick={() => toast.error(`Dispute process initiated for ORD-${order.id.slice(0, 6).toUpperCase()}. Escrow is locked.`)}
          className="flex w-full items-center justify-between rounded-xl bg-rose-500/10 px-4 py-3 text-sm font-bold text-rose-400 transition-colors hover:bg-rose-500/20"
        >
          <div className="flex items-center gap-3">
