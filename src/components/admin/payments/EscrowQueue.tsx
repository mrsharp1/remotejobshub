  ...
  if (payments.length === 0) {
    return (
      <div className="rounded-2xl border border-dashed border-border bg-card/40 py-16 text-center">
        ...
        <h3 className="text-sm font-bold text-foreground">No active escrow transactions</h3>
        <p className="mt-1 text-xs text-muted-foreground">There are no records matching your query filter.</p>
      </div>
    )
  }

  return (
    <div className="overflow-hidden rounded-2xl border border-border bg-card shadow-xl backdrop-blur-xl">
                ...
                >
                  ...
                  <td className="p-4">
                    <div className="flex items-center gap-2">
                      <div className="flex h-6 w-6 items-center justify-center rounded-full bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400">
                  ...
                  {/* Listing */}
                  <td className="p-4">
                    <span className="block truncate max-w-[150px] font-medium text-muted-foreground">
                      {listingTitle}
                    </span>
                  </td>
                  ...
                  <td className="p-4 text-right">
                    <button
                      onClick={() => onInspect(p)}
                      className="inline-flex items-center gap-1 rounded-xl bg-indigo-600/10 border border-indigo-500/20 px-3 py-1.5 text-[10px] font-bold text-indigo-600 dark:text-indigo-400 transition-all hover:bg-indigo-600 hover:text-white dark:hover:text-white"
                    >
