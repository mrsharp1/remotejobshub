...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: 'marketplace', element: <Suspense fallback={<LoadingScreen />}><MarketplacePage /></Suspense> },
      { path: 'listing/:id', element: <Suspense fallback={<LoadingScreen />}><ListingDetailPage /></Suspense> },
      { path: 'about', element: <Suspense fallback={<LoadingScreen />}><AboutPage /></Suspense> },
      { path: 'contact', element: <Suspense fallback={<LoadingScreen />}><ContactPage /></Suspense> },
      { path: 'pricing', element: <Suspense fallback={<LoadingScreen />}><PricingPage /></Suspense> },
      { path: 'community', element: <Suspense fallback={<LoadingScreen />}><CommunityPage /></Suspense> },
  ...
  },
  {
    ...
    errorElement: <ErrorBoundary />,
    children: [
      { path: 'dashboard', element: <Suspense fallback={<LoadingScreen />}><DashboardOverviewPage /></Suspense> },
      { path: 'seller', element: <Suspense fallback={<LoadingScreen />}><SellerDashboardPage /></Suspense> }
    ]
  },
  {
    element: <AdminLayout />,
    errorElement: <ErrorBoundary />,
    children: [
      { path: 'admin', element: <Suspense fallback={<LoadingScreen />}><AdminDashboardPage /></Suspense> }
    ]
  }
])
