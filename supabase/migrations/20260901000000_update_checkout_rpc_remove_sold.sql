-- 20260901000000_update_checkout_rpc_remove_sold.sql
-- This migration replaces the checkout RPC to stop marking listings as 'sold' after purchase.
...
BEGIN
    ...
    -- 2 & 3. Fetch and validate listing (lock to prevent concurrent purchases)
    ...
    -- NOTE: The automatic status change to 'sold' has been removed to support multi‑buyer listings.
