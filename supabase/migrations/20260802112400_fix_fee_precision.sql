-- 20260802112400_fix_fee_precision.sql
-- Fixes rounding errors where the platform fee was rounded to the nearest integer instead of 2 decimal places.
...
BEGIN
    ...
    DECLARE
        v_buyer_fee numeric;
    BEGIN
        -- FIX: Round to 2 decimal places instead of nearest integer
